        ...
        renderPage: function renderPage() {
            ...
            if (event.target.getAttribute('href') === '#news') {
                ...
                for (var _i = 0; _i < items.length; _i++) {
                    if (items[_i].classList.contains('active')) items[_i].classList.remove('active');
                }
                event.target.classList.toggle('active');
            }
            if (event.target.getAttribute('href') === '#contact') {
                ...
                for (var _i2 = 0; _i2 < items.length; _i2++) {
                    if (items[_i2].classList.contains('active')) items[_i2].classList.remove('active');
                }
                event.target.classList.toggle('active');
            }
            ...
            directives: [
              {
                ...
                rawName: "v-show",
                value: this.home,
                expression: "this.home"
              }
            ],
            attrs: { id: "home" }
          },
          [
            _c("h1", [_vm._v("Home Route")]),
            _vm._v(" "),
            _c(
              "div",
